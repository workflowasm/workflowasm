...
export default class CommentsParser extends BaseParser {
  addComment(comment: Comment): void {
    if (this.filename !== undefined) comment.loc.filename = this.filename
  ...
  finalizeComment(commentWS: CommentWhitespace) {
    ...
    if (
      ...
      commentWS.trailingNode !== undefined
    ) {
      if (commentWS.leadingNode !== undefined) {
        setTrailingComments(commentWS.leadingNode, comments)
      }
      if (commentWS.trailingNode !== undefined) {
      ...
      if (node === undefined)
        throw new Error(
          "Invariant violation: `containingNode` was undefined. (Should be impossible.)"
        )
